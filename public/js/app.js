...
var series = document.querySelectorAll('.sidebar .item');
var seriesTitle = document.querySelectorAll('[data-currentserie]');
// const allSerieName = Array.from(series).map(item => item.getAttribute('data-serie'));

series.forEach(function (serie) {
    serie.addEventListener('click', function () {
        var serieName = serie.getAttribute('data-serie');
        var containerSerieTitle = document.querySelector('[data-currentserie=' + serieName + ']');

        // Remove all active
        series.forEach(function (el) {
            return el.classList.remove('active');
        });
        seriesTitle.forEach(function (el) {
            return el.classList.remove('active');
        });
